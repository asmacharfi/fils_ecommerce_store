...
export function WelcomeScreen({ onSuggestionClick }: WelcomeScreenProps) {
  return (
    <div className="flex h-full min-h-[280px] flex-col items-center justify-center px-4 text-center">
      ...
      <h3 className="mt-4 text-lg font-medium text-zinc-900 dark:text-zinc-100">How can I help?</h3>
      <p className="mt-2 max-w-xs text-sm text-zinc-500 dark:text-zinc-400">
        Browse the catalog, get suggestions based on your history and cart, and view your orders when signed in.
      </p>
      ...
      <div className="mt-6 flex items-start gap-2 rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-left text-xs text-zinc-600 dark:border-zinc-700 dark:bg-zinc-900/40 dark:text-zinc-400">
        ...
        <span>
          Sign in from the header to link purchases to your account and ask the assistant about order tracking.
        </span>
      </div>
    </div>
  );
